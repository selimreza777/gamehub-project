...
const MyProfile = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#0e172b] px-2 sm:px-0 py-6">
      <div className="bg-slate-900/70 backdrop-blur-md p-8 rounded-2xl shadow-2xl w-full max-w-md text-center border border-slate-700">
        ...
        {message && (
          <p
            className={`mt-3 ${message.includes("successfully") ? "text-green-400" : "text-red-400"}`}
          >
            {message}
          </p>
        )}
        ...
        <div className="mt-6 text-left text-gray-300 space-y-2">
          ...
          <p>
            <strong className="text-yellow-400">Display Name:</strong> {user?.displayName || "Not set"}
          </p>
          {user?.photoURL && (
